# Relato dos Resultados do Storyboard – Cinemark
## Introdução
...
|----------------|------------------|------------------|--------------|--------|-----------------|
|Ana Joyce|	Joyce|	20:00	|20:15|	15/12/2024|	Microsoft Teams|
...
#### Tabela 2 – Sumário de Perguntas e Respostas (Tarefa: Buscar Sessão)
|Pergunta|	Resposta|
|--------|---------|
...
#### Tabela 3 – Sumário de Perguntas e Respostas (Tarefa: Comprar Ingresso)
|Pergunta| 	Resposta| 
|--------|---------|
...
#### Tabela 4 – Sumário de Perguntas e Respostas (Tarefa: Receber Ajuda)
|Pergunta|	Resposta|
|--------|---------|
...
#### Tabela 5 – Sumário de Perguntas e Respostas (Tarefa: Cancelar Ingresso)
|Pergunta	|Resposta|
|-----------|--------|
...
#### Tabela 6 – Sumário de Perguntas e Respostas (Tarefa: Visualizar Pedidos)
|Pergunta|	Resposta|
|--------|---------|
...
#### Tabela 7 – Sumário de Perguntas e Respostas (Tarefa: Avaliar Filme)
|Pergunta	|Resposta|
|-----------|--------|
...
#### Tabela 8 – Sumário de Perguntas e Respostas (Tarefa: Contatar Administradores)
|Pergunta	|Resposta|
|-----------|--------|
