...
- [**Perfil do usuário**](https://interacao-humano-computador.github.io/2024.2-Cinemark/Analise-de-requisitos/perfil-de-usuario/)
- [**Aspectos Éticos de Pesquisas Envolvendo Pessoas**](https://interacao-humano-computador.github.io/2024.2-Cinemark/Analise-de-requisitos/aspectos-eticos/) 
- [**Análise de tarefas**](https://interacao-humano-computador.github.io/2024.2-Cinemark/Analise-de-requisitos/analise-de-tarefas/)
...
| 02/12/2024 | Análise de Tarefas   |  [Anne de Capdeville](https://github.com/nanecapde)    |
...
| ---------------------------------------------------------------------------------------------------- | ------------- | --------------------------- |
| 1 - O histórico de versão padronizado? (<a href="#REF2">2</a>)                 | Sim           | 1.0, 03/12/2024, 22:23      |
| 2 – O(s) autor(es) e o(s) revisor(es) para cada artefato? (<a href="#REF2">2</a>) | Sim           | 1.0, 03/12/2024, 22:27      |
| 3 - Referências bibliográficas e/ou bibliografia em todos os artefatos?    (<a href="#REF2">2</a>) | Sim           | 1.0, 03/12/2024, 22:30      |
| 4 - As tabelas e imagens possuem legenda e fonte e elas chamadas dentro do texto?  (<a href="#REF2">2</a>) | Sim    | 1.0, 03/12/2024, 22:34      |
| 5 - Um texto fazendo uma introdução dos artefatos? (<a href="#REF2">2</a>)  | Sim           | 1.0, 03/12/2024, 22:37      |
| 6 - O cronograma executado com quem realizou cada artefato/atividade com as datas de início e fim? (<a href="#REF2">2</a>) | Incompleto    | 1.1, 10/02/2024, 11:00      |
| 7 - Ata(s) da(s) reuniões (com data, horário de início e fim, participantes, objetivos, etc.)    (<a href="#REF2">2</a>)  | Incompleto         | 1.0, 03/12/2024, 22:44      |
| 8 – A gravação da reunião do grupo. (<a href="#REF2">2</a>)     | Não           | 1.0, 03/12/2024, 22:44      |
| 9 - Vídeo de apresentação na categoria “não listado” no YouTube?   (<a href="#REF2">2</a>)    | Sim           | 1.0, 03/12/2024, 22:45      |
